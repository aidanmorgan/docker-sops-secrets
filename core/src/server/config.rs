...
impl Default for ServerConfig {
    fn default() -> Self {
        Self {
            sops_file_path: "/etc/sops-secrets/secrets.json".to_string(),
            master_key_path: "/etc/sops-secrets/master_key.age".to_string(),
            docker_socket_path: "/var/run/docker.sock".to_string(),
            docker_network_name: None,
            secrets_dir: "/var/tmp/sops-secrets".to_string(),
