...
#[derive(Parser, Debug)]
#[command(author, version, about = "Export secrets from sops-secrets server as environment variables or files")]
struct Args {
    ...
    /// Server URL
    #[arg(long, env = "SOPS_SERVER_URL", default_value = "http://localhost:8080")]
    server_url: String,
    ...
    /// Directory to write secret files to (only used with --export-dir)
